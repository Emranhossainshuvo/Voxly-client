        ...
        <>
            <div className="flex gap-5">
                ...
                <div className="max-w-lg mt-10 p-8 rounded-lg">
                    <h3>Welcome to Voxly</h3>
                    <p>Shape the future, voice your opinions, and earn seamlessly with our cutting-edge Voxly integrated with secure and rewarding payment options.</p>
